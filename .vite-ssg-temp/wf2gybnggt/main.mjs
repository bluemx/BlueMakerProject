...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrIncludeBooleanAttr } from "vue/server-renderer";
import { useRouter, useRoute } from "vue-router";
import JSZipUtils from "jszip-utils";
import saveAs from "file-saver";
import draggable from "vuedraggable";
import Crunker from "https://cdn.jsdelivr.net/gh/jackedgson/crunker/src/crunker.js";
...
const localesMap = Object.fromEntries(
  Object.entries(/* @__PURE__ */ Object.assign({ "../../locales/ar.yml": () => import("./assets/ar-8e1b196e.js"), "../../locales/de.yml": () => import("./assets/de-7df5b382.js"), "../../locales/en.yml": () => import("./assets/en-bac4b919.js"), "../../locales/es.yml": () => import("./assets/es-d9ef4e77.js"), "../../locales/fr.yml": () => import("./assets/fr-e096b0d2.js"), "../../locales/id.yml": () => import("./assets/id-acf81b58.js"), "../../locales/it.yml": () => import("./assets/it-ffbd7fe4.js"), "../../locales/ja.yml": () => import("./assets/ja-6ec07a99.js"), "../../locales/ka.yml": () => import("./assets/ka-655dd0fe.js"), "../../locales/ko.yml": () => import("./assets/ko-1dc57899.js"), "../../locales/pl.yml": () => import("./assets/pl-cbaec9fc.js"), "../../locales/pt-BR.yml": () => import("./assets/pt-BR-6155bb49.js"), "../../locales/ru.yml": () => import("./assets/ru-978dcb9e.js"), "../../locales/tr.yml": () => import("./assets/tr-c2668707.js"), "../../locales/uk.yml": () => import("./assets/uk-4915a9b4.js"), "../../locales/uz.yml": () => import("./assets/uz-be0c8a2a.js"), "../../locales/vi.yml": () => import("./assets/vi-29b7c744.js"), "../../locales/zh-CN.yml": () => import("./assets/zh-CN-fa0fe36b.js") })).map(([path, loadLocale]) => {
    var _a;
...
const _sfc_main$l = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    function convertAndCheckStatus(convertOptions) {
      ...
      return axios.post("https://play.ht/api/v1/convert", convertOptions.body, { headers: convertOptions.headers }).then((response) => response.status === 201 ? response.data.transcriptionId : Promise.reject("Conversion request failed")).then((transcriptionId) => {
        const articleStatusUrl = `https://play.ht/api/v1/articleStatus?transcriptionId=${transcriptionId}`;
        let convertedData = null;
        const intervalId = setInterval(() => {
          axios.get(articleStatusUrl, { headers: convertOptions.headers }).then((response) => response.data).then((data) => {
            if (data.converted) {
    ...
    function mergeAudios() {
      ...
      crunker.fetchAudio(...audios).then((buffers) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UButton = resolveComponent("UButton");
      const _component_AudioToAssets = _sfc_main$m;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-primary-900 mt-2 border-t-4 border-t-teal px-1 pb-5" }, _attrs))}><div class="mt-4 p-1 text-xs font-bold"> Conversación </div>`);
      _push(ssrRenderComponent(unref(draggable), {
        ...
        item: withCtx(({ element, index }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mb-0.5 bg-slate-600/60 text-xs ring-1 transition-all"${_scopeId}><div class="to-primary-300 flex items-center justify-between gap-1 from-teal-600 bg-gradient-to-r"${_scopeId}><div class="handle grow cursor-grab items-center justify-between px-1"${_scopeId}>${ssrInterpolate(element.name)}</div>`);
            _push2(ssrRenderComponent(_component_UPopover, {
              ...
              content: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span p-1 text-xs dark:text-white${_scopeId2}>Duplicar</span>`);
                } else {
                  return [
                    createVNode("span", {
                      "p-1": "",
            ...
            _push2(`</div><div${_scopeId}><textarea placeholder="Diálogo" class="w-full resize-none rounded bg-dark text-xs text-white"${_scopeId}>${ssrInterpolate(element.content)}</textarea>`);
            if (element.audiofile) {
              _push2(`<div class="flex gap-1 px-1 pb-2 text-xs"${_scopeId}><div class="flex justify-center gap-1 rounded"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UButton, {
                size: "xs",
                class: "i-solar-play-linear bg-white",
                onClick: ($event) => playudio(`dial${index}`)
              ...
              _push2(`<audio${ssrRenderAttr("id", `dial${index}`)}${ssrRenderAttr("src", element.audiofile.audioUrl)} type="audio/mp3" invisible w-0${_scopeId}></audio></div><div class="text-[6px]"${_scopeId}>${ssrInterpolate(element.audiofile.audioUrl)}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
            ...
            return [
              createVNode("div", { class: "mb-0.5 bg-slate-600/60 text-xs ring-1 transition-all" }, [
                createVNode("div", { class: "to-primary-300 flex items-center justify-between gap-1 from-teal-600 bg-gradient-to-r" }, [
                  createVNode("div", { class: "handle grow cursor-grab items-center justify-between px-1" }, toDisplayString(element.name), 1),
                ...
                createVNode("div", null, [
                  withDirectives(createVNode("textarea", {
                    ...
                    placeholder: "Diálogo",
                    class: "w-full resize-none rounded bg-dark text-xs text-white"
                  }, null, 8, ["onUpdate:modelValue"]), [
                    [vModelText, element.content]
                  ]),
                  element.audiofile ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "flex gap-1 px-1 pb-2 text-xs"
                  }, [
                    createVNode("div", { class: "flex justify-center gap-1 rounded" }, [
                      createVNode(_component_UButton, {
                        size: "xs",
                        class: "i-solar-play-linear bg-white",
                        onClick: ($event) => playudio(`dial${index}`)
                      ...
                      createVNode("audio", {
                        id: `dial${index}`,
                        src: element.audiofile.audioUrl,
                        type: "audio/mp3",
                        invisible: "",
                        "w-0": ""
                      }, null, 8, ["id", "src"])
                    ]),
                    createVNode("div", { class: "text-[6px]" }, toDisplayString(element.audiofile.audioUrl), 1)
      ...
      if (!unref(loading) && unref(voices).length) {
        _push(ssrRenderComponent(_component_UButton, {
          class: "ml-auto",
          type: "accent",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Generar conversación `);
            } else {
              return [
                createTextVNode(" Generar conversación ")
              ];
            }
          }),
          _: 1
      ...
      if (unref(loading)) {
        _push(`<div class="text-accent-100 flex items-center justify-center gap-1 text-xs"><div class="i-solar-refresh-circle-broken ml-auto text-xl" animate-spin></div><span>Procesando...</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="mt-2 bg-slate-400 p-1"><!--[-->`);
      ssrRenderList(unref(audiofiles), (item, index) => {
        _push(`<div class="mb-0.5 w-full bg-slate-700 p-1"><div class="flex items-center gap-1 text-sm"><div><strong class="text-sm">${ssrInterpolate(item.voice)}</strong><span class="ml-1 inline-block text-[8px] leading-2">${ssrInterpolate(item.content)}</span></div><div class="ml-auto flex justify-center gap-1 rounded">`);
        _push(ssrRenderComponent(_component_UButton, {
          size: "xs",
          class: "i-solar-play-linear bg-white",
        ...
        _push(`<audio${ssrRenderAttr("id", `b${index}`)}${ssrRenderAttr("src", item.audioUrl)} type="audio/mp3" invisible w-0></audio></div><div class="ml-2 flex justify-center text-right">`);
...
_sfc_main$l.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/BDAudioConversation.vue");
...
const _sfc_main$k = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UPopover = resolveComponent("UPopover");
      const _component_AudioToAssets = _sfc_main$m;
      const _component_BDAudioConversation = _sfc_main$l;
      ...
      if (!unref(loading)) {
        ...
        ssrRenderList(unref(voicesFilter), (item, index) => {
          ...
          _push(ssrRenderComponent(_component_UButton, {
            size: "xs",
            class: "i-solar-user-plus-line-duotone bg-white",
            onClick: ($event) => addToConversation(item)
          }, null, _parent));
          _push(ssrRenderComponent(_component_UButton, {
            size: "xs",
            class: "i-solar-play-linear bg-white",
      ...
      _push(`</div><div class="bg-slate-400 p-1 mt-2"><!--[-->`);
      ssrRenderList(unref(audiofiles), (item, index) => {
      ...
      _push(`<!--]--></div>`);
      _push(ssrRenderComponent(_component_BDAudioConversation, {
        ref_key: "conversationVoices",
        ref: conversationVoices
      }, null, _parent));
      _push(`</div>`);
    };
  }
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  const _component_BuilderDetailsAssetsUploader = _sfc_main$i;
  const _component_BuilderDetailsAssetsList = _sfc_main$j;
  _push(`<!--[-->`);
...
const __unplugin_components_3 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$2]]);
...
const _sfc_main$c = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d;
      const _component_UPopover = resolveComponent("UPopover");
      const _component_BDModulosSaveTemplate = _sfc_main$d;
      const _component_UButton = resolveComponent("UButton");
      const _component_BDModulosTemplates = _sfc_main$e;
      const _component_BDModulosInputs = _sfc_main$b;
        ...
        _push(ssrRenderComponent(unref(draggable), {
          ...
          item: withCtx(({ element, index }, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              ...
              _push2(`</div></div><div class="flex gap-y-0.5 gap-x-1 items-center justify-center bg-gradient-to-l from-white to-white/10 px-1"${_scopeId}>`);
              if (element == null ? void 0 : element.name) {
                ...
                createVNode("div", {
                  ...
                  createVNode("div", {
                    ...
                    createVNode("div", { class: "handle flex gap-1 items-center justify-between grow px-1 cursor-grab p-0.5" }, [
                      createVNode("div", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("div", { class: "text-[10px]" }, toDisplayString(__props.level), 1),
                        ...
                        (element == null ? void 0 : element.symbol) ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", null, toDisplayString(element.symbol), 1)
                        ])) : createCommentVNode("", true),
                        element.block == "separator" ? (openBlock(), createBlock("div", {
                          key: 1,
                          flex: "",
                          "items-center": "",
                          "justify-between": "",
                          ...
                          createVNode("div", null, toDisplayString(element.text), 1)
                          ...
                          createVNode("div", { class: "flex gap-2 items-center" }, [
                            createVNode("div", null, toDisplayString(element.block), 1),
                            element.block == "text" && element.text ? (openBlock(), createBlock("div", {
                              key: 0,
                              class: "text-[10px] text-ellipsis leading-2 bg-red-900/50 p0.5"
                            }, toDisplayString(element.text.substring(0, 10)), 1)) : createCommentVNode("", true),
                            element.block == "word" && element.word ? (openBlock(), createBlock("div", {
                              key: 1,
                              class: "text-[10px] text-ellipsis leading-2 bg-teal-600/50 p0.5"
                            }, toDisplayString(element.word.substring(0, 10)), 1)) : createCommentVNode("", true),
                            element.block == "image" && element.file ? (openBlock(), createBlock("div", {
                              key: 2,
                              class: "text-[10px] text-ellipsis leading-2 bg-blue-900/50 p0.5"
                            }, toDisplayString(element.file.split("/").slice(-1)[0].substring(0, 10)), 1)) : createCommentVNode("", true),
                            element.block == "icon" && element.icon ? (openBlock(), createBlock("div", {
                              key: 3,
                              class: "text-[10px] text-ellipsis leading-2 bg-gray-900/50 p0.5"
                            }, toDisplayString(element.icon.substring(0, 10)), 1)) : createCommentVNode("", true)
                          ])
                        ]))
                      ], 8, ["onClick"])
                    ]),
                    createVNode("div", { class: "flex gap-y-0.5 gap-x-1 items-center justify-center bg-gradient-to-l from-white to-white/10 px-1" }, [
                      ...
                      (element == null ? void 0 : element.content) ? (openBlock(), createBlock("div", {
                        key: 2,
                        class: ["leading-2", unref(collapsecontent)[moduloName + index] ? "bg-lime-300 rounded" : ""]
                      }, [
                        createVNode(_component_UPopover, { trigger: "hover" }, {
                          content: withCtx(() => [
                            createVNode("span", {
                              "dark:text-white": "",
                              "text-xs": "",
                  ...
                  unref(accordion)[moduloName + index] && element.block == "template" ? (openBlock(), createBlock(_component_BDModulosTemplates, {
                    ...
                    data: element,
                    onLoadBlock: ($event) => templateLoad(element, index, $event)
                  }, null, 8, ["data", "onLoadBlock"])) : createCommentVNode("", true),
                  unref(accordion)[moduloName + index] ? (openBlock(), createBlock("div", { key: 1 }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(Object.keys(element), (itemNest, indexNest) => {
                  ...
                  !unref(collapsecontent)[moduloName + index] ? (openBlock(true), createBlock(Fragment, { key: 2 }, renderList(Object.keys(element), (itemNest, indexNest) => {
                    return openBlock(), createBlock(Fragment, { key: indexNest }, [
...
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_BDModulosDropzones = _sfc_main$c;
      if (__props.itemKey != "block") {
        ...
        if (typeof unref(refData)[__props.itemKey] != "object") {
          ...
          if ((_a = unref(properties)) == null ? void 0 : _a.input) {
            _push(`<div class="grid grid-cols-4 items-center p-1">`);
                  ...
                  if (_push2) {
                    ...
                    return [
                      createVNode("div", { class: "flex gap-1" }, [
                        ...
                        createVNode("div", null, toDisplayString(item.label), 1)
                      ])
                    ];
                  }
                }),
              ...
              _push(ssrRenderComponent(_component_URadio, {
                ...
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                    ...
                    return [
                      createTextVNode(toDisplayString(pItem), 1)
                    ];
                  }
                }),
                _: 2
            ...
            _push(`<div class="${ssrRenderClass([[__props.itemKey == "class" ? "bg-primary/70" : "", __props.itemKey == "id" ? "bg-secondary/30" : "", __props.itemKey == "text" ? "bg-rose-600/30" : ""], "grid grid-cols-4 items-center px-1 py-0.5"])}">`);
          ...
          _push(`<div><div p-1 class="${ssrRenderClass(["bg-" + levelColor()])}" text-white cursor-pointer>${ssrInterpolate(__props.itemKey)} ${ssrInterpolate((_f = unref(properties)) == null ? void 0 : _f.input)} </div>`);
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", {
                ...
                createVNode("div", { class: "text-[6px] break-words" }, toDisplayString(element.name), 1)
              ], 8, ["title"])
            ];
          }
        }),
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    const contentModel = ref(builderstore.doc ? builderstore.doc.content : "");
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BuilderDetailsBlocks = _sfc_main$a;
      const _component_BDModulosInputs = _sfc_main$b;
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    const builderstore = useBuilderStore();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BuilderDetailsModulos = _sfc_main$9;
      const _component_BuilderDetailsCodigo = _sfc_main$f;
      const _component_BuilderDetailsPrompts = _sfc_main$g;
      const _component_BuilderDetailsAssets = __unplugin_components_3;
      const _component_BuilderDetailsAudios = _sfc_main$k;
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_BuilderNotes = _sfc_main$7;
      _push(`<aside${ssrRenderAttrs(mergeProps({
        "w-10": "",
        flex: "",
        "flex-col": "",
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    const builderstore = useBuilderStore();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BuilderMenu = _sfc_main$6;
      const _component_BuilderDetails = _sfc_main$8;
      const _component_RouterView = resolveComponent("RouterView");
      _push(`<main${ssrRenderAttrs(mergeProps({
        "h-screen": "",
        "w-screen": "",
...
const __layout_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$3 = {};
...
const __layout_3 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender]]);
const layouts = {
  "404": _sfc_main$n,
  "builder": _sfc_main$5,
  "default": __layout_2,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useI18n();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UserAuth = _sfc_main$1;
...
const __pages_import_0__ = () => import("./assets/index-535dd674.js");
const __pages_import_2__ = () => import("./assets/dashboard-5593c7a8.js");
const __pages_import_3__ = () => import("./assets/about-ec73afb8.js");
const __pages_import_4__ = () => import("./assets/README-f009a94f.js");
const __pages_import_5__ = () => import("./assets/_...all_-b11f9144.js");
const __pages_import_6__ = () => import("./assets/_name_-74e3ec5d.js");
const __pages_import_7__ = () => import("./assets/_key_-8f4bf44a.js");
const routes$1 = [{ "name": "riodas", "path": "/riodas", "component": __pages_import_0__, "props": true, "meta": { "layout": "builder", "requiresAuth": true } }, { "name": "index", "path": "/", "component": _sfc_main, "props": true, "meta": { "layout": "home", "requiresAuth": false } }, { "name": "dashboard", "path": "/dashboard", "component": __pages_import_2__, "props": true, "meta": { "layout": "default", "requiresAuth": true } }, { "name": "about", "path": "/about", "component": __pages_import_3__, "props": true }, { "name": "README", "path": "/readme", "component": __pages_import_4__, "props": true }, { "name": "all", "path": "/:all(.*)*", "component": __pages_import_5__, "props": true, "meta": { "layout": 404 } }, { "name": "hi-name", "path": "/hi/:name", "component": __pages_import_6__, "props": true }, { "name": "riodas-key", "path": "/riodas/:key", "component": __pages_import_7__, "props": true, "meta": { "layout": "builder", "requiresAuth": true } }];
const main = "";
const __uno = "";
