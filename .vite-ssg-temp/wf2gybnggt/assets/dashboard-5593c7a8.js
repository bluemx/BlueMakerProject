import { useSSRContext, mergeProps, ref, unref, defineComponent, resolveComponent, withCtx, createVNode } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderComponent } from "vue/server-renderer";
import { a as useUserStore, s as supabase, _ as _export_sfc, f as favicon, b as block0 } from "../main.mjs";
...
import "file-saver";
import "vuedraggable";
import "https://cdn.jsdelivr.net/gh/jackedgson/crunker/src/crunker.js";
import "axios";
import "openai";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_AdminAuthorized = _sfc_main$2;
...
const __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UserLogout = _sfc_main$3;
