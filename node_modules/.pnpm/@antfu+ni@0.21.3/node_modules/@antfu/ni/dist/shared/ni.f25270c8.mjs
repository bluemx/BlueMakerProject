...
async function openTemp() {
  ...
  const competitivePath = join$1(CLI_TEMP_DIR, `.${process.pid}.${counter}`);
  counter++;
...
export { $, AGENTS as A, CLI_TEMP_DIR as C, INSTALL_PAGE as I, LOCKS as L, UnsupportedCommand as U, agents as a, getDefaultAgent as b, getGlobalAgent as c, detect as d, getCommand as e, parseNr as f, getConfig as g, parseNu as h, parseNun as i, parseNlx as j, parseNa as k, run as l, remove as m, exclude as n, cmdExists as o, parseNi as p, getVoltaPrefix as q, runCli as r, prompts as s, writeFileSafe as w };
