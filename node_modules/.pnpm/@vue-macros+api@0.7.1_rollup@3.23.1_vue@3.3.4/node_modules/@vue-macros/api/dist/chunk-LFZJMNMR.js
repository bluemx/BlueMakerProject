"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }// src/resolve.ts
var _fs = require('fs');
...
async function resolveTSTemplateLiteral({
  ...
  async function resolveKeys(prefix, quasis, expressions) {
    ...
    if (expressions.length === 0) {
      return [prefix + (_nullishCoalesce(((_a = quasis[0]) == null ? void 0 : _a.value.cooked), () => ( "")))];
    }
...
exports.createUnionType = createUnionType; exports.createStringLiteral = createStringLiteral; exports.createTSLiteralType = createTSLiteralType; exports.resolveTSFileId = resolveTSFileId; exports.resolveTSFileIdNode = resolveTSFileIdNode; exports.setResolveTSFileIdImpl = setResolveTSFileIdImpl; exports.isTSDeclaration = isTSDeclaration; exports.mergeTSProperties = mergeTSProperties; exports.checkForTSProperties = checkForTSProperties; exports.resolveTSProperties = resolveTSProperties; exports.getTSPropertiesKeys = getTSPropertiesKeys; exports.resolveReferenceName = resolveReferenceName; exports.resolveTSTemplateLiteral = resolveTSTemplateLiteral; exports.resolveTSLiteralType = resolveTSLiteralType; exports.resolveTypeElements = resolveTypeElements; exports.resolveTSIndexedAccessType = resolveTSIndexedAccessType; exports.resolveTSTypeOperator = resolveTSTypeOperator; exports.resolveMaybeTSUnion = resolveMaybeTSUnion; exports.tsFileCache = tsFileCache; exports.getTSFile = getTSFile; exports.resolveTSScope = resolveTSScope; exports.isSupportedForTSReferencedType = isSupportedForTSReferencedType; exports.resolveTSReferencedType = resolveTSReferencedType; exports.namespaceSymbol = namespaceSymbol; exports.isTSNamespace = isTSNamespace; exports.resolveTSNamespace = resolveTSNamespace; exports.RollupResolve = RollupResolve;
