...
var helperPrefix = "/vue-macros/define-models";
...
function transformDefineModels(code, id, version, unified) {
  ...
  function processDefineModels(node, declId, kind) {
    var _a;
    if (_common.isCallOf.call(void 0, node, _common.DEFINE_MODELS))
      mode = "runtime";
    else if (_common.isCallOf.call(void 0, node, _common.DEFINE_MODELS_DOLLAR))
...
${_common.REPO_ISSUE_URL}`
  ...
  if (!code.includes(_common.DEFINE_MODELS))
    return;
